    ...
    function layoutWindows(
        ...
        windows.forEach((w: Window) => {
            ...
            if (newWidth + originX > constrainX) {
                ...
                originY = targetWindow ? targetWindow.top + targetWindow.height + FULL_WINDOW_MARGIN : FULL_WINDOW_MARGIN;
            }
            ...
            if (newHeight + originY > constrainY) {
                ...
                originX = targetWindow ? targetWindow.left + targetWindow.width + FULL_WINDOW_MARGIN : FULL_WINDOW_MARGIN;
                originY = FULL_WINDOW_MARGIN;
            }
...
<div class="container">
    ...
    <div bind:this={resizeController} class="resize-controller">
        ...
        <div class="ctrl" data-tag="top"></div>
