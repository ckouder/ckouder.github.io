        ...
        let tick = (e: MouseEvent) => {
            ...
            let size = {
                ...
                left: resizeEl.dataset["tag"].includes("left")
                    ? e.clientX
                    : windowSize.left,
                right: resizeEl.dataset["tag"].includes("right")
                    ? r
                    : windowSize.right,
    ...
    <div class="window" class:focused={focus} on:mousedown={onWindowClicked}>
        <div class="toolbar">
            ...
            <div class="btn-container">
                ...
                <div class="btn btn-min" on:mouseup={onMinBtnClicked} class:disabled={noResize} aria-disabled={noResize}/>
                <div class="btn btn-max" on:mouseup={onMaxBtnClicked} class:disabled={noResize} aria-disabled={noResize}/>
            </div>
            <div
